...
1. As with any repo, clone it using `git clone https://github.com/NicoStroh/backend.git`
...
To facilitate easy debugging of services, the docker containers are set up to expose all important ports to the host machine. This can easily be seen in Docker Desktop. Port mappings can also be found [on the wiki](https://meitrex.readthedocs.io/en/latest/dev-manuals/architecture/Ports.html).
